                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url(request()->segment(1).'/'.request()->segment(2))}}"> مدیریت منو داشبورد</a></li>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body" style="background-color: #0000000a;border-radius: 10px 10px 0px 0px;">
                                ...
                                <div class="card-body">
                                <form action="{{ route('menu-dashboard.store')}}" id="form" method="POST">
                                    <div class="row row-sm">
                                        {{csrf_field()}}
                                        <div class="col-md-12">
                                           {{-- @include('error')--}}
    ...
    <script>
        jQuery(document).ready(function(){
            jQuery('#submit').click(function(e){
                ...
                jQuery.ajax({
                    url: "{{ route('menu-dashboard.store') }}",
                    method: 'POST',
                    data: {
                        "_token"    : "{{ csrf_token() }}",
