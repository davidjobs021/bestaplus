                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url(request()->segment(1).'/'.request()->segment(2))}}"> مدیریت زیر منو داشبورد</a></li>
                ...
                <div class="row row-sm">
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('submenu-dashboard.update', $submenupanel->id)}}" method="POST">
                                    {{csrf_field()}}
                                    {{ method_field('PATCH') }}
    ...
    <script>
        jQuery(document).ready(function(){
            jQuery('#submit').click(function(e){
                ...
                jQuery.ajax({
                    url: "{{ route('submenu-dashboard.update' , $submenupanel->id) }}",
                    method: 'PATCH',
                    data: {
                        "_token": "{{ csrf_token() }}",
