                    ...
                    <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                        <div class="card-body p-0">
                            <svg width="90" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <g><path d="m432.468 68.082-28.227-21.529 17.955-23.541c5.945-7.795 17.083-9.294 24.878-3.349 7.795 5.945 9.294 17.083 3.349 24.878z" fill="#f4fbff"></path></g>
                                    <g>
                                        <path
                                    ...
                                    <g><path d="m82.297 68.082 28.227-21.529-17.956-23.541c-5.945-7.795-17.083-9.294-24.878-3.349-7.795 5.945-9.294 17.083-3.349 24.878z" fill="#f4fbff"></path></g>
                                    <g>
                                        <path
                                    ...
                                    <g><path d="m196.612 430.719-61.914-34.255-27.607 80.128c-3.332 9.671.766 20.337 9.716 25.289 8.95 4.952 20.164 2.757 26.587-5.203z" fill="#365e7d"></path></g>
                                    <g><path d="m174.916 418.715-52.048 64.508c-3.921 4.859-9.628 7.556-15.515 7.805 1.729 4.485 4.987 8.381 9.454 10.852 8.95 4.952 20.164 2.757 26.587-5.203l53.218-65.958z" fill="#2b4d66"></path></g>
                                    <g><path d="m318.153 430.719 61.914-34.255 27.607 80.128c3.332 9.671-.766 20.337-9.716 25.289-8.95 4.952-20.164 2.757-26.587-5.203z" fill="#365e7d"></path></g>
                                    <g>
                                        <path
                                    ...
                                    <g><circle cx="257.382" cy="289.055" fill="#ffe07d" r="183.405"></circle></g>
                                    <g>
                                        <path
                                    ...
                                    <g><circle cx="257.382" cy="289.055" fill="#365e7d" r="28.238"></circle></g>
                                    <g>
                                        <path
